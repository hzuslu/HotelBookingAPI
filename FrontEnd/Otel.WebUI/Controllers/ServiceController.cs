...
namespace Otel.WebUI.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            var responseMessage = await client.GetAsync("https://localhost:7250/api/Service");
        ...
        public async Task<IActionResult> AddService(CreateServiceDTO model)
        {
            ...
            var response = await client.PostAsync("https://localhost:7250/api/Service", jsonContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.DeleteAsync($"https://localhost:7250/api/Service/{id}");
            if (response.IsSuccessStatusCode)
                return RedirectToAction("Index");
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync($"https://localhost:7250/api/Service/{id}");
        ...
        public async Task<IActionResult> UpdateService(UpdateServiceDTO updateServiceDTO)
        {
            ...
            var response = await client.PutAsync("https://localhost:7250/api/Service", stringContent);
