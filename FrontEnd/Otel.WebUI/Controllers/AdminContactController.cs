    ...
    public class AdminContactController : Controller
    {
        ...
        public async Task<IActionResult> Inbox([FromQuery] int? categoryId)
        {
            ...
            var responseMessage = await client.GetAsync(categoryId != null
                                   ? $"https://localhost:7250/api/Contact/category/{categoryId}"
                                   : "https://localhost:7250/api/Contact");
        ...
        public async Task<IActionResult> ReadEmail([FromRoute] string id)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:7250/api/Contact/{id}");
        ...
        public async Task<IActionResult> SendEmail(SendMessageDTO sendMessageDTO)
        {
            ...
            var responseMessage = await client.GetAsync($"https://localhost:7250/api/Contact/{sendMessageDTO.ContactID}");
            ...
            var response = await client.PutAsync("https://localhost:7250/api/Contact", stringContent);
