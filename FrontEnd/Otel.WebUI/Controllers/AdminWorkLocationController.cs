...
namespace Otel.WebUI.Controllers
{
    public class AdminWorkLocationController : Controller
    {
        ...
        public async Task<IActionResult> AddWorkLocation(CreateWorkLocationDTO model)
        {
            ...
            var response = await client.PostAsync("https://localhost:7250/api/WorkLocation", jsonContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.GetAsync($"https://localhost:7250/api/WorkLocation/{id}");
        ...
        public async Task<IActionResult> UpdateWorkLocation(UpdateWorkLocationDTO updateWorkLocationDTO)
        {
            ...
            var response = await client.PutAsync("https://localhost:7250/api/WorkLocation", stringContent);
        ...
        {
            var client = _httpClientFactory.CreateClient();
            var response = await client.DeleteAsync($"https://localhost:7250/api/WorkLocation/{id}");
